...
function _INIT()
  ...
  game.addCredit("Game", "Kitchen Sink Demo", "Feature Showcase")
...
function _DRAW()
  ...
  rf.print_anchored("KITCHEN SINK DEMO", "topcenter", 15)
  
  -- Draw subtitle (centered manually with offset from top)
  local subtitle_y = 20
  local subtitle_w = #"All Features Showcase" * 6
  rf.print_xy((480 - subtitle_w) / 2, subtitle_y, "All Features Showcase", 7)
